...
public class CartDAOImpl implements CartDAO {
	...
	public List<Cart> showUserCart(int userId) throws SQLException {
		...
		String userCart="select cart_id,email_id,flower_name,order_quantity,total_price,order_date from cart_items "
				+ "inner join user_details using (user_id) inner join inventory using(flower_id) where user_id=?";
